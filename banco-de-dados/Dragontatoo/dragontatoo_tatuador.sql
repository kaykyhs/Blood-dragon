...
CREATE TABLE `tatuador` (
  ...
  `mei` varchar(10) DEFAULT NULL,
  `fk_Pessoa_id_pessoa` int DEFAULT NULL,
  PRIMARY KEY (`id_tatuador`),
  KEY `FK_Tatuador_2` (`fk_Pessoa_id_pessoa`),
  CONSTRAINT `FK_Tatuador_2` FOREIGN KEY (`fk_Pessoa_id_pessoa`) REFERENCES `pessoa` (`id_pessoa`) ON DELETE CASCADE
...
INSERT INTO `tatuador` VALUES (1,'1234567890',1),(2,'9876543210',2),(3,'4567890123',3),(4,'3216549876',4),(5,'7893216540',5);
